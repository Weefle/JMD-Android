	...
	public static boolean generateYearRapport(Annee ann, Context c) {
		...
		if (ann.getMoyenne() != -1.0) {
			...
			if (ann.getDecoupage() == DecoupageType.NULL) {
				...
				paint.setFakeBoldText(true);
				page.getCanvas().drawText("Moyenne générale : ", 50, startY, paint);
				paint.setFakeBoldText(false);
				page.getCanvas().drawText(ann.getMoyenne() + "/20", 165, startY, paint);
				startY += 15;
				paint.setFakeBoldText(true);
				page.getCanvas().drawText("Résultat : ", 50, startY, paint);
				paint.setFakeBoldText(false);
				...
				paint2.setFakeBoldText(true);
				page2.getCanvas().drawText("Moyenne générale : ", 50, startY_2, paint2);
				paint2.setFakeBoldText(false);
				page2.getCanvas().drawText(ann.getMoyenne() + "/20", 165, startY_2, paint2);
				startY_2 += 15;
				paint2.setFakeBoldText(true);
				page2.getCanvas().drawText("Résultat : ", 50, startY_2, paint2);
				paint2.setFakeBoldText(false);
				...
				paint3.setFakeBoldText(true);
				page3.getCanvas().drawText("Moyenne générale : ", 50, startY_3, paint3);
				paint3.setFakeBoldText(false);
				page3.getCanvas().drawText(ann.getMoyenne() + "/20", 165, startY_3, paint3);
				startY_3 += 15;
				paint3.setFakeBoldText(true);
				page3.getCanvas().drawText("Résultat : ", 50, startY_3, paint3);
				paint3.setFakeBoldText(false);
